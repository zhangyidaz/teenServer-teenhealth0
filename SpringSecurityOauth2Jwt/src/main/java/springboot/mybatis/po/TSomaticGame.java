...
public class TSomaticGame {
    ...
    public void setLevelFlex(String levelFlex) {
        this.levelFlex = levelFlex == null ? null : levelFlex.trim();
    }
    ...
    public void setLevelBlan(String levelBlan) {
        this.levelBlan = levelBlan == null ? null : levelBlan.trim();
    }
    ...
    public void setLevelJump(String levelJump) {
        this.levelJump = levelJump == null ? null : levelJump.trim();
    }
    ...
    public void setLevelChoosetime(String levelChoosetime) {
        this.levelChoosetime = levelChoosetime == null ? null : levelChoosetime.trim();
    }
